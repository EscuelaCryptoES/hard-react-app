...
export class Dapp extends Component {
      ...
      <div className="container p-4">
        <div className="row">
          <div className="col-12">
            ...
            <p>
              Your Hardhat & React Enviroment is installed and ready.<br/>
              If your contracts compiled and migrated successfully, between will show
              a stored value of 5 (by default)<br/>
              Try changing the value stored on <strong> line 49 </strong> of Dapp.js.
            </p>
          </div>
        </div>
  ...
  _startPollingData() {
    //this._pollDataInterval = setInterval(() => this._updateValue(), 1000);
  ...
  async _updateValue() {
    const storedData = await this._simpleStorage.get(); 
    this.setState({ storedValue : storedData.toString() });
  }
  ...
  _checkNetwork() {
    ...
    this.setState({ 
      networkError: 'Por favor, conecta Metamask a localhost:8545'
    });
